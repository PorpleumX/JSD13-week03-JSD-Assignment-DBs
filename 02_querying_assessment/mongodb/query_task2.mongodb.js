...
//
// Your thinking:
//1.ดูข้อมูลในดาต้าที่มี ที่เกี่ยวข้องกับ jane doe ในดาต้า orders
//2.เรียกดาต้าเบส เจน โด ในดาต้า orders
//3.เรียกข้อมูลที่เกี่ยวข้องตามโจทย์ที่กำหนด โดยใส่เงื่อนไขเพิ่ม
//4.กำหนดให้ส่งค่าออกมาเพียงที่โจทย์กำหนดให้
